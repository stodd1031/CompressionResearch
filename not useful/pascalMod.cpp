...
void setupKeys(short**& keys, PASCALTYPE** pascal, short size, short mod)
{
    short** keysActual;
    ...
    for (short index = 0; index < size; index++)
    {
        ...
        {
            botItem += pascal[size - 1 - index2][size - 1 - index + index2] * keysActual[keyLeftArr][index2];
        }
        keysActual[keyBotArr][index] = botItem % mod;
    }
    ...
    for (short index = 0; index < size; index++)
    {
        ...
        for (short index2 = 0; index2 < index + 1; index2++)
        {
            rightItem += pascal[size - 1 - index2][size - 1 - index + index2] * keysActual[keyLeftArr][size - 1 - index2];
        }
        keysActual[keyRightArr][index] = rightItem % mod;
    }
...
void setupPascal(PASCALTYPE**& pascal, short size, short mod)
{

    /// create 2D array size x size
    pascal = new unsigned char * [size];
    for (short index = 0; index < size; index++)
    {
        pascal[index] = new unsigned char[size];
    }
    ...
    for (short index = 0; index < size; index++)
    {
        pascal[index][size - 1] = 1; // right collumn
        pascal[size - 1][index] = 1; // top row
    }
    ...
    for (short y = size - 2; y > -1; y--)
    {
        ...
        {
            std::cout << +pascal[y + 1][x] << " + " << +pascal[y][x + 1] << " = " << +(pascal[y + 1][x] + pascal[y][x + 1]) % mod << std::endl;
            pascal[y][x] = (pascal[y + 1][x] + pascal[y][x + 1]) % mod;
            // mod of above;
        }
    }
}

void displayPascal(PASCALTYPE** pascal, short size)
{
    for (short y = size - 1; y > -1; y--)
    {
        for (short x = 0; x < size; x++)
...
void recMiddle(short current, short* leftArr, short* botArr, PASCALTYPE** pascal, short** keys, short size, short sizeChange, short mod, short& ret);

void recEnd(short current, short* leftArr, short* botArr, PASCALTYPE** pascal, short** keys, short size, short sizeChange, short mod, short& ret);

void recZero(short* leftArr, short* botArr, PASCALTYPE** pascal, short** keys, short size, short mod, short& ret)
...
void recMiddle(short current, short* leftArr, short* botArr, PASCALTYPE** pascal, short** keys, short size, short sizeChange, short mod, short& ret)
{
    ...
    {
        diff += pascal[size - 1 - index][size - 1 - current + index] * leftArr[index];
    }
    diff = diff % mod;
...
void recEnd(short current, short* leftArr, short* botArr, PASCALTYPE** pascal, short** keys, short size, short sizeChange, short mod, short& ret)
{
    ...
    for (short index = 0; index < size; index++)
    {
        ...
        for (short index2 = 0; index2 < index + 1; index2++)
        {
            rightItem += pascal[size - 1 - index2][size - 1 - index + index2] * leftArr[size - 1 - index2];
        }
